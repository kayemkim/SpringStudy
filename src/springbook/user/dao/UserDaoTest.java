...
import springbook.user.dao.mongo.UserDaoMongodb;
...
public class UserDaoTest {
	...
	@Autowired UserDaoMongodb mongoDao;
	...
	public void addMongo() {
		mongoDao.add(user1);
		User user = mongoDao.get(user1.getId());
		assertEquals(user1.getName(), user.getName());
	}
	
	@Test
	public void deleteAllMongo() {
		mongoDao.add(user1);
		mongoDao.deleteAll();
		assertEquals(0, mongoDao.getCount());
	}
